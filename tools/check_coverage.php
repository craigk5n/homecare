 ...
 *
 * Expects coverage.xml from phpunit --coverage-clover.
 * Reports src/ line coverage; fails <80%.
 */

$cloverPath = 'coverage.xml';
...
$allPct = $allLines > 0 ? round(100 * $allCovered / $allLines, 1) : 0.0;
$srcPct = $srcLines > 0 ? round(100 * $srcCovered / $srcLines, 1) : 0.0;
